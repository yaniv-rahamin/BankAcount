...
{
    internal class CheckingAccount:BasicAccount
    {
        #region fields
       protected double approvedOverdraft;
        ...
        #region constructors
        public CheckingAccount(int account, int bankBranch, int bank, int id, int balance, int approvedOverdraft):base(account, id,bankBranch,bank, balance)
        {           
